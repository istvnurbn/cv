...
\geometry{left=1.4cm, top=0.8cm, right=1.4cm, bottom=1.4cm, footskip=0.5cm}
...
\input{sections/technical_competencies.tex}
\input{sections/languages.tex}
\input{sections/personal_skills.tex}
\input{sections/free_time_activities.tex}
